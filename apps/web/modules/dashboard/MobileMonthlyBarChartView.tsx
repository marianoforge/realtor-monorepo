...
interface MobileMonthlyBarChartViewProps {
  data: MonthlyData[];
...
const MobileMonthlyBarChartView: React.FC<MobileMonthlyBarChartViewProps> = ({
  data,
  currencySymbol,
  totalPreviousYear,
  totalCurrentYear,
        ...
        <div className="mb-6 p-4 rounded-xl border border-gray-200 bg-gradient-to-r from-emerald-50 to-green-50">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">{bestMonth.month}</p>
            </div>
          </div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: ROSEN_CHART_COLORS[1].bg,
                      }}
                    ></div>
                  </div>
                </div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: ROSEN_CHART_COLORS[0].bg,
                      }}
                    ></div>
                  </div>
                </div>
...
export default MobileMonthlyBarChartView;
